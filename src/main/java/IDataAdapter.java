...
public interface IDataAdapter {
    ...
    public static final int PRODUCT_SAVED_OK = 100;
    public static final int PRODUCT_DUPLICATE_ERROR = 101;

    public static final int PURCHASE_SAVED_OK = 200;
    public static final int PURCHASE_DUPLICATE_ERROR = 201;
